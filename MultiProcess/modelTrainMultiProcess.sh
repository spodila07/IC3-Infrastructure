#!/bin/bash
#SBATCH --job-name=modelTrainMultiProcess_job_test     # Job name
...
#SBATCH --output=modelTrainMultiProcess_test_%j.out    # Standard output and error log
...
# Replace 'modelTrainMultiProcess.py' with the actual filename of your Python script
# Make sure the Python script is in the same directory as this SLURM script or provide the correct path
module load python
python modelTrainMultiProcess.py
